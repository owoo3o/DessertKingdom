<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="inquiry.model.vo.Faq" %>
<%
...
<head>
  ...
  <style>
  #faq{background:#222831; color:#fff};
  </style>
        ...
        <!-- 사용할 부분 board list 시작-->
          <div class="detail_outer">
            ...
            <div class="table-area">
              <form action="<%= request.getContextPath() %>/update.faq" method="post" id="detailForm">
                <table>
<!--                   <header><h4 class="b_title">FAQ 수정</h4></header> -->
                  <tr>
                      <!-- 글 번호 숨기기 -->

                      <td class="tr_title">제목</td>
                      <td class="td_content" colspan="5">
                        <input type="text" id="q_Title" name="faqTitle" value="<%= f.getBoardTitle() %>">
	                    <input type="hidden" name="bId" value="<%= f.getBoardId() %>">
                      </td>
                    </tr>
                    
                    <tr>
                      <td class="tr_title">작성자</td>
                      <td class="td_content">관리자</td>

                      <td class="tr_title">분류</td>
                      <td class="td_content">
                        <select name="category">
                          <option>-------</option>
                          <option value="10" <%= f.getCateName().equals("클래스 문의") ? "selected":"" %>>클래스 문의</option>
                          <option value="20" <%= f.getCateName().equals("환불 및 취소") ? "selected":"" %>>환불 및 취소</option>
                          <option value="30" <%= f.getCateName().equals("기타") ? "selected":"" %>>기타</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="6"><textarea name="content" cols="70px" rows="15px" style="resize:none;"><%= f.getBaordContent() %></textarea></td>
                    </tr>
                  </table>
                    ...
                    <div class="btn-box">
                        ...
                        <input type="button" onclick="location.href='<%= request.getContextPath() %>/list.faq'" id="cancleBtn" value="취소">
                    </div>
