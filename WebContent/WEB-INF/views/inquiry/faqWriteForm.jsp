        ...
        <!-- 사용할 부분 board list 시작-->
          <div class="detail_outer">
            ...
            <div class="table-area">
              <form action="<%= request.getContextPath() %>/insert.faq" method="post" id="detailForm" onsubmit="return invalidForm();">
                <table>
                  <header><h4 class="b_title">FAQ 작성</h4></header>
                  <tr>
                      <!-- 글 번호 숨기기 -->
                    ...
                    <tr>
                      <td colspan="6"><textarea id="content" cols="70px" rows="15px" style="resize:none;" name="faqcontent" ></textarea></td>
                    </tr>
                  </table>
