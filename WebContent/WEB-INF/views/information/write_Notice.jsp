    ...
    <div class="container">
    	<h4>New Notice</h4>
  		...
  		<div class="writeN_area">
			<form action="<%= request.getContextPath() %>/writeNotice" method="post">
				<table>
					<tr>
						<th>제목</th>
						<td colspan="3">
							<input type="text" size="50" name="notice_Title">
						</td>				
					</tr>
					<tr>
						<th>노출일</th>
						<td>
							<input type="date" name="writeN_c"> ~ <input type="date" name="writeN_d">
						</td>
					</tr>
					<tr>
						<td colspan="3">
							<textarea name="notice_Content" cols="60" rows="15" style="resize:none;"></textarea>
						</td>
					</tr>
				</table>
