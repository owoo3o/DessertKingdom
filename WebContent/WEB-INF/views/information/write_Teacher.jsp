    ...
    <div class="container">
    	<h4>New Teachers</h4>
  		...
  		<div class="writeT_area">
			<form action="<%= request.getContextPath() %>/writeTeacher" method="post" encType="multipart/form-data">
				<table>
					<tr>
						<th>강사명</th>
						<td>
							<input type="text" size="20" name="teacher_Name">
						</td>	
						<!-- 
						<th>조회유무</th>
						<td>
							<label>Y</label>
							<input type="radio" name="teacher_Status" value="Y" class="status" checked="checked">
							<label>N</label>
							<input type="radio" name="teacher_Status" value="N"  class="status">
						</td>	 
						-->			
					</tr>
					<tr>
						...
						<td colspan="3">
							<div id="teacher_Photo">
								<img id="teacherImg" width="350" height="200">
								이미지크기 350*200
							</div>
						</td>
					</tr>
					...
					<tr>
						<td colspan="3">
							<textarea name="teacher_Content" cols="60" rows="5" style="resize:none;"></textarea>
						</td>
					</tr>
					<tr class="fileArea">
						<td colspan="3">
