...
<%
	ReviewBoard r = (ReviewBoard)request.getAttribute("r");
            ...
            <!-- 사용할 부분 board list 시작-->
              <div class="detail_outer">
                ...
                <div class="table-area">
                  <form action="<%= request.getContextPath() %>/update.th" method="post" id="detailForm"  enctype="multipart/form-data">
                    <table >
                      ...
                      <tr>
                          ...
                          <td class="td_content" colspan="5">
                            <input type="text" id="title" name="title" value="<%= r.getBoardTitle() %>">
                          </td>
                        </tr>
                        
<!--                         <tr> -->
<!--                           <td class="tr_title">작성자</td> -->
<!--                           <td class="td_content" id="writer" ></td> -->
...
<!--                         </tr> -->
                        ...
                        <tr>
                          <td colspan="6"><textarea cols="70px" rows="15px" style="resize:none;" name="content"><%= r.getBoardContent() %></textarea></td>
                        </tr>
                        <!-- 사진 보이게할지 -->
                    <!--    <tr> 
